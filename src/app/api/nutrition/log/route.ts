  ...
  try {
    const { data: log, error: logError } = await supabase
      ...
      .insert({
        ...
        cholesterol_mg:  totals.cholesterol_mg ?? null,
        saturated_fat_g: totals.saturated_fat_g ?? null,
        trans_fat_g:     totals.trans_fat_g ?? null,
        potassium_mg:    totals.potassium_mg ?? null,
        calcium_mg:      totals.calcium_mg ?? null,
        iron_mg:         totals.iron_mg ?? null,
        vitamin_c_mg:    totals.vitamin_c_mg ?? null,
        vitamin_d_mcg:   totals.vitamin_d_mcg ?? null,
